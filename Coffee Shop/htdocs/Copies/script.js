            ...
            cart.forEach(item => {
                ...
                itemElement.innerHTML = `
                    ...
                    <div class="item-controls">
                        <button class="quantity-update" data-action="decrease" data-name="${item.product}">-</button>
                        <span class="item-quantity">${item.quantity}</span>
                        <button class="quantity-update" data-action="increase" data-name="${item.product}">+</button>
                        <button class="remove-from-cart" data-name="${item.product}">Remove</button>
                    </div>
                `;
